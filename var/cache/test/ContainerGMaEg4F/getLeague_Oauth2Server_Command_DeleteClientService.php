 ...
 */
class getLeague_Oauth2Server_Command_DeleteClientService extends App_KernelTestDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->privates['league.oauth2_server.command.delete_client'] = $instance = new \League\Bundle\OAuth2ServerBundle\Command\DeleteClientCommand(($container->privates['league.oauth2_server.manager.in_memory.client'] ?? $container->load('getLeague_Oauth2Server_Manager_InMemory_ClientService')));
