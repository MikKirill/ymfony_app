 ...
 */
class getLeague_Oauth2Server_Grant_RefreshTokenService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'league.oauth2_server.grant.refresh_token' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->privates['league.oauth2_server.grant.refresh_token'] = $instance = new \League\OAuth2\Server\Grant\RefreshTokenGrant(($container->privates['league.oauth2_server.repository.refresh_token'] ?? $container->load('getLeague_Oauth2Server_Repository_RefreshTokenService')));
