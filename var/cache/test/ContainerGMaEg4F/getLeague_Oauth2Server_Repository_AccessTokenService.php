 ...
 */
class getLeague_Oauth2Server_Repository_AccessTokenService extends App_KernelTestDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $a = ($container->privates['league.oauth2_server.manager.in_memory.client'] ?? $container->load('getLeague_Oauth2Server_Manager_InMemory_ClientService'));
        ...
        return $container->privates['league.oauth2_server.repository.access_token'] = new \League\Bundle\OAuth2ServerBundle\Repository\AccessTokenRepository(($container->privates['league.oauth2_server.manager.in_memory.access_token'] ??= new \League\Bundle\OAuth2ServerBundle\Manager\InMemory\AccessTokenManager(true)), $a, ($container->privates['league.oauth2_server.converter.scope'] ??= new \League\Bundle\OAuth2ServerBundle\Converter\ScopeConverter()));
    }
}
