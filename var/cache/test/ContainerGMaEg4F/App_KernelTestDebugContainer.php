...
class App_KernelTestDebugContainer extends Container
{
    ...
    {
        return $this->services['cache.security_is_granted_attribute_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('7P4rYHPSCH', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? $this->getLoggerService()));
    }
    ...
    protected function get_Doctrine_Orm_DefaultMetadataDriverService()
    {
        ...
        $b = ($this->privates['doctrine.orm.default_attribute_metadata_driver'] ??= new \Doctrine\ORM\Mapping\Driver\AttributeDriver([0 => (\dirname(__DIR__, 4).'/src/Entity'), 1 => (\dirname(__DIR__, 4).'/vendor/league/oauth2-server-bundle/src/Entity')]));

        $a->addDriver($b, 'App\\Entity');
        $a->addDriver($b, 'League\\Bundle\\OAuth2ServerBundle\\Entity');
    ...
    {
        return $this->privates['api_platform.cache.metadata.property'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('SWDd+GEGtn', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? $this->getLoggerService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('kFg-oMGqh1', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? $this->getLoggerService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource_collection'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('nwHvmjZNFj', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? $this->getLoggerService()));
    }
    ...
    {
        return $this->privates['api_platform.metadata.property.identifier_metadata_factory.attribute'] = new \ApiPlatform\Metadata\Property\Factory\AttributePropertyMetadataFactory(($this->privates['api_platform.metadata.property.identifier_metadata_factory.identifier'] ?? $this->getApiPlatform_Metadata_Property_IdentifierMetadataFactory_IdentifierService()));
    }

    /**
     * Gets the private 'api_platform.metadata.property.identifier_metadata_factory.cached' shared service.
     *
     * @return \ApiPlatform\Metadata\Property\Factory\CachedPropertyMetadataFactory
     */
    protected function getApiPlatform_Metadata_Property_IdentifierMetadataFactory_CachedService()
    {
        return $this->privates['api_platform.metadata.property.identifier_metadata_factory.cached'] = new \ApiPlatform\Metadata\Property\Factory\CachedPropertyMetadataFactory(($this->privates['api_platform.cache.metadata.property'] ?? $this->getApiPlatform_Cache_Metadata_PropertyService()), ($this->privates['api_platform.metadata.property.identifier_metadata_factory.xml'] ?? $this->getApiPlatform_Metadata_Property_IdentifierMetadataFactory_XmlService()));
    }

    /**
     * Gets the private 'api_platform.metadata.property.identifier_metadata_factory.identifier' shared service.
     *
     * @return \ApiPlatform\Metadata\Property\Factory\IdentifierPropertyMetadataFactory
     */
    protected function getApiPlatform_Metadata_Property_IdentifierMetadataFactory_IdentifierService()
    {
        return $this->privates['api_platform.metadata.property.identifier_metadata_factory.identifier'] = new \ApiPlatform\Metadata\Property\Factory\IdentifierPropertyMetadataFactory(($this->privates['api_platform.resource_class_resolver'] ?? $this->getApiPlatform_ResourceClassResolverService()), ($this->privates['api_platform.doctrine.orm.metadata.property.identifier_metadata_factory'] ?? $this->getApiPlatform_Doctrine_Orm_Metadata_Property_IdentifierMetadataFactoryService()));
    }
    ...
    {
        return $this->privates['api_platform.metadata.resource.metadata_collection_factory.xml'] = new \ApiPlatform\Metadata\Resource\Factory\ExtractorResourceMetadataCollectionFactory(($this->privates['api_platform.metadata.resource_extractor.xml'] ??= new \ApiPlatform\Metadata\Extractor\XmlResourceExtractor([], $this)), ($this->privates['api_platform.metadata.resource.metadata_collection_factory.deprecations'] ?? $this->getApiPlatform_Metadata_Resource_MetadataCollectionFactory_DeprecationsService()), $this->parameters['api_platform.defaults'], ($this->privates['logger'] ?? $this->getLoggerService()), false);
    }
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ZsKpK9ASYI', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? $this->getLoggerService()));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Yx2j01UobS', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? $this->getLoggerService()));
    }
    ...
    {
        return $this->privates['doctrine.orm.default_attribute_metadata_driver'] = new \Doctrine\ORM\Mapping\Driver\AttributeDriver([0 => (\dirname(__DIR__, 4).'/src/Entity'), 1 => (\dirname(__DIR__, 4).'/vendor/league/oauth2-server-bundle/src/Entity')]);
    }
    ...
    protected function getDoctrine_Orm_DefaultConfigurationService()
    {
        ...
        $instance->setEntityNamespaces(['App' => 'App\\Entity', 'LeagueOAuth2ServerBundle' => 'League\\Bundle\\OAuth2ServerBundle\\Entity']);
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'league.oauth2_server.persistence.in_memory.enabled' => true,
