 ...
 */
class getLeague_Oauth2Server_Controller_AuthorizationService extends App_KernelTestDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['league.oauth2_server.controller.authorization'] = new \League\Bundle\OAuth2ServerBundle\Controller\AuthorizationController(($container->privates['league.oauth2_server.authorization_server'] ?? $container->load('getLeague_Oauth2Server_AuthorizationServerService')), ($container->services['event_dispatcher'] ?? $container->getEventDispatcherService()), ($container->privates['league.oauth2_server.factory.authorization_request_resolve_event'] ?? $container->load('getLeague_Oauth2Server_Factory_AuthorizationRequestResolveEventService')), ($container->privates['league.oauth2_server.converter.user'] ??= new \League\Bundle\OAuth2ServerBundle\Converter\UserConverter()), ($container->privates['league.oauth2_server.manager.in_memory.client'] ?? $container->load('getLeague_Oauth2Server_Manager_InMemory_ClientService')), ($container->privates['league.oauth2_server.factory.psr_http'] ?? $container->load('getLeague_Oauth2Server_Factory_PsrHttpService')), ($container->privates['league.oauth2_server.factory.http_foundation'] ??= new \Symfony\Bridge\PsrHttpMessage\Factory\HttpFoundationFactory()), ($container->privates['league.oauth2_server.factory.psr17'] ??= new \Nyholm\Psr7\Factory\Psr17Factory()));
    }
}
